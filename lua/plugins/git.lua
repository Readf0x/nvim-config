return require"genvim".inject {
	{
		...
		keys = function() local gs = require"gitsigns.actions"; return {
			{ "<C-g>r", function() gs.reset_hunk() end, {"n","v"}, desc = "Reset hunk" }, { "<C-g>s", function() require"gitsigns.actions".stage_hunk() end, {"n","v"}, desc = "Stage hunk" },
